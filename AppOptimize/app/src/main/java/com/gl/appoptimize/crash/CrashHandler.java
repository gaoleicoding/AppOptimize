...
//        mContext.startActivity(new Intent(mContext, CrashActivity.class));
    ...
    public void collectDeviceInfo(Context ctx) {
        try {
            ...
            LogUtils.e("CrashHandleran.NameNotFoundException---> error occured when collect package info", e.toString());
        }
        ...
        for (Field field : fields) {
            try {
                ...
                LogUtils.e("CrashHandler.NameNotFoundException---> an error occured when collect crash info", e.toString());
            }
        }
    }
